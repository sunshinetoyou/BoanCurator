...
import com.boancurator.app.ui.screens.home.HomeViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.boancurator.app.ui.screens.profile.ProfileViewModel;
import com.boancurator.app.ui.screens.profile.ProfileViewModel_HiltModules;
import com.boancurator.app.ui.screens.profile.ProfileViewModel_HiltModules_BindsModule_Binds_LazyMapKey;
import com.boancurator.app.ui.screens.profile.ProfileViewModel_HiltModules_KeyModule_Provide_LazyMapKey;
import com.boancurator.app.ui.screens.search.SearchViewModel;
import com.boancurator.app.ui.screens.search.SearchViewModel_HiltModules;
...
public final class DaggerBoanCuratorApp_HiltComponents_SingletonC {
  private DaggerBoanCuratorApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public BoanCuratorApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements BoanCuratorApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public BoanCuratorApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements BoanCuratorApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public BoanCuratorApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements BoanCuratorApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public BoanCuratorApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements BoanCuratorApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public BoanCuratorApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements BoanCuratorApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public BoanCuratorApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements BoanCuratorApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public BoanCuratorApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements BoanCuratorApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public BoanCuratorApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends BoanCuratorApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends BoanCuratorApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends BoanCuratorApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends BoanCuratorApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends BoanCuratorApp_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityRetainedCImpl extends BoanCuratorApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends BoanCuratorApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends BoanCuratorApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.bookmarkStateHolderProvider = DoubleCheck.provider(new SwitchingProvider<BookmarkStateHolder>(singletonCImpl, 11));
      this.authRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<AuthRepository>(singletonCImpl, 10));
      this.bookmarkRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<BookmarkRepository>(singletonCImpl, 12));
      this.ratingRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<RatingRepository>(singletonCImpl, 13));
      this.keywordRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<KeywordRepository>(singletonCImpl, 14));
      this.notificationRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<NotificationRepository>(singletonCImpl, 15));
      this.sourceRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<SourceRepository>(singletonCImpl, 16));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 7: // com.boancurator.app.data.api.TokenAuthenticator 
          ...
          case 10: // com.boancurator.app.data.repository.AuthRepository 
          ...
          case 11: // com.boancurator.app.data.repository.BookmarkStateHolder 
          return (T) new BookmarkStateHolder();

          case 12: // com.boancurator.app.data.repository.BookmarkRepository 
          return (T) new BookmarkRepository(singletonCImpl.provideApiServiceProvider.get());

          case 13: // com.boancurator.app.data.repository.RatingRepository 
          return (T) new RatingRepository(singletonCImpl.provideApiServiceProvider.get());

          case 14: // com.boancurator.app.data.repository.KeywordRepository 
          return (T) new KeywordRepository(singletonCImpl.provideApiServiceProvider.get());

          case 15: // com.boancurator.app.data.repository.NotificationRepository 
          return (T) new NotificationRepository(singletonCImpl.provideApiServiceProvider.get());

          case 16: // com.boancurator.app.data.repository.SourceRepository 
